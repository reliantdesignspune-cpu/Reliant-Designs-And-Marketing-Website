                        ...
                        <div className="space-y-2">
                            ...
                            >
                                ...
                                <SelectContent className="bg-white z-[110] text-black">
                                    ...
                                    <SelectItem value="App Development" className="text-black hover:bg-gray-100 hover:text-[#ea580c] hover:font-bold focus:bg-gray-100 focus:text-[#ea580c] focus:font-bold cursor-pointer transition-colors">App Development</SelectItem>
                                    <SelectItem value="Outdoor Advertising" className="text-black hover:bg-gray-100 hover:text-[#ea580c] hover:font-bold focus:bg-gray-100 focus:text-[#ea580c] focus:font-bold cursor-pointer transition-colors">Outdoor Advertising</SelectItem>
